...
void train_xor() {
    ...
    for (int epoch = 0; epoch < epochs; epoch++) {
        ...
        new_w1 = update_weights(Weights_1, grad_w1, learning_rate);
        new_w2 = update_weights(Weights_2, grad_w2, learning_rate);
        new_b1 = update_weights(Bias_1, grad_b1, learning_rate);
        new_b2 = update_weights(Bias_2, grad_b2, learning_rate);
        ...
        if (epoch % 100000 == 0) {  // Every 100k epochs
