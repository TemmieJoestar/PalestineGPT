...
clean:
	@rm -f main xor_problem iris_dataset *.mem *.o *.memcheck test_layer_norm test_vocab ffn_test test_attention test_matrix test_embedding test_input_pipeline test_ngram
